...
Public Sub FastLine(ByRef Hdc As Long, ByRef X1 As Long, ByRef Y1 As Long, _
                    ByRef X2 As Long, ByRef Y2 As Long, ByRef W As Long, ByRef color As Long, Optional NewPen As Boolean = True)
Attribute FastLine.VB_Description = "disegna line veloce"

    Dim poi            As POINTAPI


    If NewPen Then DeleteObject (SelectObject(Hdc, CreatePen(vbSolid, W, color)))
